...
model_de_v5 <- paste("voted ~", paste(demo_de, collapse="+"),
                     paste("+"), paste(bert_pca_cluster_reduced_small, collapse="+"), paste("+ no_reduced_bert"))
model_de_v6 <- paste("voted ~", paste(demo_de, collapse="+"),
...
model_fr_v4 <- paste("voted ~", paste(demo_fr, collapse="+"),
                     ...
                     paste("+"), paste(bert_pca_cluster_reduced_cn, collapse="+"),
                     paste("+"), paste(bert_pca_cluster_reduced_cr, collapse="+"), paste("+ no_reduced_bert"))
model_fr_v5 <- paste("voted ~", paste(demo_fr, collapse="+"),
                     paste("+"), paste(bert_pca_cluster_reduced_small, collapse="+"), paste("+ no_reduced_bert"))
model_fr_v6 <- paste("voted ~", paste(demo_fr, collapse="+"),
...
model_uk_v4 <- paste("voted ~", paste(demo_uk, collapse="+"),
                     ...
                     paste("+"), paste(bert_pca_cluster_reduced_cn, collapse="+"),
                     paste("+"), paste(bert_pca_cluster_reduced_cr, collapse="+"), paste("+ no_reduced_bert"))
model_uk_v5 <- paste("voted ~", paste(demo_uk, collapse="+"),
                     paste("+"), paste(bert_pca_cluster_reduced_small, collapse="+"), paste("+ no_reduced_bert"))
model_uk_v6 <- paste("voted ~", paste(demo_uk, collapse="+"),
...
ggsave("v_coef.png", width = 7.5, height = 6)
...
ggsave("v_perf.png", width = 6, height = 6)
