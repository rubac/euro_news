...
model_de_v1 <- paste("polinterest ~", paste(demo_de, collapse="+"))
model_de_v2 <- paste("polinterest ~", paste(demo_de, collapse="+"),
...
model_de_v5 <- paste("polinterest ~", paste(demo_de, collapse="+"),
                     paste("+"), paste(bert_pca_cluster_reduced_small, collapse="+"), paste("+ no_reduced_bert"))
model_de_v6 <- paste("polinterest ~", paste(demo_de, collapse="+"),
                     paste("+"), paste(bert_pca_cluster_reduced_s_de, collapse="+"), paste("+ no_reduced_bert"))

model_fr_v1 <- paste("polinterest ~", paste(demo_fr, collapse="+"))
model_fr_v2 <- paste("polinterest ~", paste(demo_fr, collapse="+"),
                     paste("+"), paste(pred_track_cat_dom_all, collapse="+"), paste("+ no_dom_data"), 
                     paste("+"), paste(pred_track_cat_app_all, collapse="+"), paste("+ no_app_data"))
model_fr_v3 <- paste("polinterest ~", paste(demo_fr, collapse="+"),
                     paste("+"), paste(pred_track_dom_all, collapse="+"), paste("+ no_dom_data"), 
                     paste("+"), paste(pred_track_app_all, collapse="+"), paste("+ no_app_data"))
model_fr_v4 <- paste("polinterest ~", paste(demo_fr, collapse="+"),
                     paste("+"), paste(bert_pca_cluster_reduced_pca, collapse="+"), 
                     paste("+"), paste(bert_pca_cluster_reduced_cn, collapse="+"),
                     paste("+"), paste(bert_pca_cluster_reduced_cr, collapse="+"), paste("+ no_reduced_bert"))
model_fr_v5 <- paste("polinterest ~", paste(demo_fr, collapse="+"),
                     paste("+"), paste(bert_pca_cluster_reduced_small, collapse="+"), paste("+ no_reduced_bert"))
model_fr_v6 <- paste("polinterest ~", paste(demo_fr, collapse="+"),
                     paste("+"), paste(bert_pca_cluster_reduced_s_fr, collapse="+"), paste("+ no_reduced_bert"))

model_uk_v1 <- paste("polinterest ~", paste(demo_uk, collapse="+"))
model_uk_v2 <- paste("polinterest ~", paste(demo_uk, collapse="+"),
                     paste("+"), paste(pred_track_cat_dom_all, collapse="+"), paste("+ no_dom_data"), 
                     paste("+"), paste(pred_track_cat_app_all, collapse="+"), paste("+ no_app_data"))
model_uk_v3 <- paste("polinterest ~", paste(demo_uk, collapse="+"),
                     paste("+"), paste(pred_track_dom_all, collapse="+"), paste("+ no_dom_data"),
                     paste("+"), paste(pred_track_app_all, collapse="+"), paste("+ no_app_data"))
model_uk_v4 <- paste("polinterest ~", paste(demo_uk, collapse="+"),
                     paste("+"), paste(bert_pca_cluster_reduced_pca, collapse="+"), 
                     paste("+"), paste(bert_pca_cluster_reduced_cn, collapse="+"),
                     paste("+"), paste(bert_pca_cluster_reduced_cr, collapse="+"), paste("+ no_reduced_bert"))
model_uk_v5 <- paste("polinterest ~", paste(demo_uk, collapse="+"),
                     paste("+"), paste(bert_pca_cluster_reduced_small, collapse="+"), paste("+ no_reduced_bert"))
model_uk_v6 <- paste("polinterest ~", paste(demo_uk, collapse="+"),
...
# polinterest - Germany - socio_demo
...
# polinterest - Germany - socio_demo + categories
...
# polinterest - Germany - socio_demo + domains/apps
...
# polinterest - Germany - socio_demo + reduced BERT
...
# polinterest - France - socio_demo + categories
...
# polinterest - France - socio_demo + domains/apps
...
# polinterest - France - socio_demo + reduced BERT
...
# polinterest - UK - socio_demo + categories
...
# polinterest - UK - socio_demo + domains/apps
...
# polinterest - UK - socio_demo + reduced BERT
...
ggsave("p_coef.png", width = 7.5, height = 6)
...
ggsave("p_coef2.png", width = 7.5, height = 6)
...
ggsave("p_perf.png", width = 6, height = 6)
...
ggsave("p_perf2.png", width = 6, height = 6)
...
varImp(glm_de_v6)$importance %>% 
  ...
  mutate(rowname = forcats::fct_inorder(rowname),
         row = fct_recode(rowname,
                          ...
                          "Entertain vs. GER Elections (Median)" = "median_dim3_r",
...
ggsave("p_imp_ger.png", width = 6, height = 6)
...
varImp(glm_fr_v6)$importance %>% 
  ...
  mutate(rowname = forcats::fct_inorder(rowname),
         row = fct_recode(rowname,
                          ...
                          "HH Size: 5 People" = "hh_size5People",
                          "Education: BAC+3" = "education_FR7bac3Licence",
                          "HH Size: 3 People" = "hh_size3People",
                          "Income: No Answer" = "income_FR_DENANoanswer",
                          "Employment: Missing" = "empl_status2Missing",
                          "Education: FR BAC+5" = "education_FR8Bac5Master",
...
ggsave("p_imp_fr.png", width = 6, height = 6)
...
varImp(glm_uk_v6)$importance %>% 
  ...
  mutate(rowname = forcats::fct_inorder(rowname),
         row = fct_recode(rowname,
                          ...
                          "Education: UK Postgrad." = "education_UK5Postgraduatedegreeorequivalent",
                          "Income: UK 2000-2500 pounds" = "income_UK52000to2500pounds",
...
ggsave("p_imp_uk.png", width = 6, height = 6)
