...
model_v1 <- paste("voted ~", paste(demo, collapse="+"), paste("+"), paste(media, collapse="+"))
model_v2 <- paste(model_v1, paste("+"), paste(pred_track_cat_dom_all, collapse="+"), 
                  paste("+"), paste(pred_track_cat_app_all, collapse="+"), paste("+ no_app_data"))
model_v3 <- paste(model_v1, paste("+"), paste(pred_track_dom_all, collapse="+"), 
                  paste("+"), paste(pred_track_app_all, collapse="+"), paste("+ no_app_data"))
model_v4 <- paste(model_v1, paste("+"), paste(bert_pca_cluster_all, collapse="+"), paste("+ no_bert_data"))
model_v5 <- paste(model_v1, paste("+"), paste(bert_pca_cluster_reduced_all, collapse="+"), paste("+ no_reduced_bert"))
model_v6 <- paste(model_v1, paste("+"), paste(topics_all, collapse="+"), paste("+ no_topics"))
...
set.seed(48284)
eval(parse(text=paste("xgb_de_v1a <- train(",model_v1,",
                      data = track_de_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid0,
...
set.seed(29483)
eval(parse(text=paste("xgb_de_v1 <- train(",model_v1,",
                      data = track_de_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid,
...
set.seed(29483)
eval(parse(text=paste("mb_de_v1 <- train(",model_v1,",
                      data = track_de_train,
                      method = 'glmboost',
                      trControl = ctrl,
...
# Voted - Germany - socio_demo + categories

set.seed(48284)
eval(parse(text=paste("xgb_de_v2a <- train(",model_v2,",
                      data = track_de_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid0,
...
set.seed(29483)
eval(parse(text=paste("xgb_de_v2 <- train(",model_v2,",
                      data = track_de_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid,
...
set.seed(29483)
eval(parse(text=paste("mb_de_v2 <- train(",model_v2,",
                      data = track_de_train,
                      method = 'glmboost',
                      trControl = ctrl,
                      tuneGrid = mboost_grid,
...
# Voted - Germany - socio_demo + domains/apps

set.seed(48284)
eval(parse(text=paste("xgb_de_v3a <- train(",model_v3,",
                      data = track_de_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid0,
...
set.seed(29483)
eval(parse(text=paste("xgb_de_v3 <- train(",model_v3,",
                      data = track_de_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid,
...
set.seed(29483)
eval(parse(text=paste("mb_de_v3 <- train(",model_v3,",
                      data = track_de_train,
                      method = 'glmboost',
                      trControl = ctrl,
                      tuneGrid = mboost_grid,
...
set.seed(48284)
eval(parse(text=paste("xgb_de_v4a <- train(",model_v4,",
                      data = track_de_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid0,
...
set.seed(29483)
eval(parse(text=paste("xgb_de_v4 <- train(",model_v4,",
                      data = track_de_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid,
...
set.seed(29483)
eval(parse(text=paste("mb_de_v4 <- train(",model_v4,",
                      data = track_de_train,
                      method = 'glmboost',
                      trControl = ctrl,
                      tuneGrid = mboost_grid,
...
set.seed(48284)
eval(parse(text=paste("xgb_de_v5a <- train(",model_v5,",
                      data = track_de_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid0,
...
set.seed(29483)
eval(parse(text=paste("xgb_de_v5 <- train(",model_v5,",
                      data = track_de_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid,
...
set.seed(29483)
eval(parse(text=paste("mb_de_v5 <- train(",model_v5,",
                      data = track_de_train,
                      method = 'glmboost',
                      trControl = ctrl,
                      tuneGrid = mboost_grid,
...
# Voted - Germany - socio_demo + topics

set.seed(48284)
eval(parse(text=paste("xgb_de_v6a <- train(",model_v6,",
                      data = track_de_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid0,
...
set.seed(29483)
eval(parse(text=paste("xgb_de_v6 <- train(",model_v6,",
                      data = track_de_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid,
...
set.seed(29483)
eval(parse(text=paste("mb_de_v6 <- train(",model_v6,",
                      data = track_de_train,
                      method = 'glmboost',
                      trControl = ctrl,
                      tuneGrid = mboost_grid,
...
set.seed(48284)
eval(parse(text=paste("xgb_fr_v1a <- train(",model_v1,",
                      data = track_fr_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid0,
...
set.seed(29483)
eval(parse(text=paste("xgb_fr_v1 <- train(",model_v1,",
                      data = track_fr_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid,
...
set.seed(29483)
eval(parse(text=paste("mb_fr_v1 <- train(",model_v1,",
                      data = track_fr_train,
                      method = 'glmboost',
                      trControl = ctrl,
                      tuneGrid = mboost_grid,
...
# Voted - France - socio_demo + categories

set.seed(48284)
eval(parse(text=paste("xgb_fr_v2a <- train(",model_v2,",
                      data = track_fr_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid0,
...
set.seed(29483)
eval(parse(text=paste("xgb_fr_v2 <- train(",model_v2,",
                      data = track_fr_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid,
...
set.seed(29483)
eval(parse(text=paste("mb_fr_v2 <- train(",model_v2,",
                      data = track_fr_train,
                      method = 'glmboost',
                      trControl = ctrl,
                      tuneGrid = mboost_grid,
...
# Voted - France - socio_demo + domains/apps

set.seed(48284)
eval(parse(text=paste("xgb_fr_v3a <- train(",model_v3,",
                      data = track_fr_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid0,
...
set.seed(29483)
eval(parse(text=paste("xgb_fr_v3 <- train(",model_v3,",
                      data = track_fr_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid,
...
set.seed(29483)
eval(parse(text=paste("mb_fr_v3 <- train(",model_v3,",
                      data = track_fr_train,
                      method = 'glmboost',
                      trControl = ctrl,
                      tuneGrid = mboost_grid,
...
set.seed(48284)
eval(parse(text=paste("xgb_fr_v4a <- train(",model_v4,",
                      data = track_fr_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid0,
...
set.seed(29483)
eval(parse(text=paste("xgb_fr_v4 <- train(",model_v4,",
                      data = track_fr_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid,
...
set.seed(29483)
eval(parse(text=paste("mb_fr_v4 <- train(",model_v4,",
                      data = track_fr_train,
                      method = 'glmboost',
                      trControl = ctrl,
                      tuneGrid = mboost_grid,
...
set.seed(48284)
eval(parse(text=paste("xgb_fr_v5a <- train(",model_v5,",
                      data = track_fr_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid0,
...
set.seed(29483)
eval(parse(text=paste("xgb_fr_v5 <- train(",model_v5,",
                      data = track_fr_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid,
...
set.seed(29483)
eval(parse(text=paste("mb_fr_v5 <- train(",model_v5,",
                      data = track_fr_train,
                      method = 'glmboost',
                      trControl = ctrl,
                      tuneGrid = mboost_grid,
...
# Voted - France - socio_demo + topics

set.seed(48284)
eval(parse(text=paste("xgb_fr_v6a <- train(",model_v6,",
                      data = track_fr_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid0,
...
set.seed(29483)
eval(parse(text=paste("xgb_fr_v6 <- train(",model_v6,",
                      data = track_fr_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid,
...
set.seed(29483)
eval(parse(text=paste("mb_fr_v6 <- train(",model_v6,",
                      data = track_fr_train,
                      method = 'glmboost',
                      trControl = ctrl,
                      tuneGrid = mboost_grid,
...
set.seed(48284)
eval(parse(text=paste("xgb_uk_v1a <- train(",model_v1,",
                      data = track_uk_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid0,
...
set.seed(29483)
eval(parse(text=paste("xgb_uk_v1 <- train(",model_v1,",
                      data = track_uk_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid,
...
set.seed(29483)
eval(parse(text=paste("mb_uk_v1 <- train(",model_v1,",
                      data = track_uk_train,
                      method = 'glmboost',
                      trControl = ctrl,
                      tuneGrid = mboost_grid,
...
# Voted - UK - socio_demo + categories

set.seed(48284)
eval(parse(text=paste("xgb_uk_v2a <- train(",model_v2,",
                      data = track_uk_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid0,
...
set.seed(29483)
eval(parse(text=paste("xgb_uk_v2 <- train(",model_v2,",
                      data = track_uk_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid,
...
set.seed(29483)
eval(parse(text=paste("mb_uk_v2 <- train(",model_v2,",
                      data = track_uk_train,
                      method = 'glmboost',
                      trControl = ctrl,
                      tuneGrid = mboost_grid,
...
# Voted - UK - socio_demo + domains/apps

set.seed(48284)
eval(parse(text=paste("xgb_uk_v3a <- train(",model_v3,",
                      data = track_uk_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid0,
...
set.seed(29483)
eval(parse(text=paste("xgb_uk_v3 <- train(",model_v3,",
                      data = track_uk_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid,
...
set.seed(29483)
eval(parse(text=paste("mb_uk_v3 <- train(",model_v3,",
                      data = track_uk_train,
                      method = 'glmboost',
                      trControl = ctrl,
                      tuneGrid = mboost_grid,
...
set.seed(48284)
eval(parse(text=paste("xgb_uk_v4a <- train(",model_v4,",
                      data = track_uk_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid0,
...
set.seed(29483)
eval(parse(text=paste("xgb_uk_v4 <- train(",model_v4,",
                      data = track_uk_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid,
...
set.seed(29483)
eval(parse(text=paste("mb_uk_v4 <- train(",model_v4,",
                      data = track_uk_train,
                      method = 'glmboost',
                      trControl = ctrl,
                      tuneGrid = mboost_grid,
...
set.seed(48284)
eval(parse(text=paste("xgb_uk_v5a <- train(",model_v5,",
                      data = track_uk_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid0,
...
set.seed(29483)
eval(parse(text=paste("xgb_uk_v5 <- train(",model_v5,",
                      data = track_uk_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid,
...
set.seed(29483)
eval(parse(text=paste("mb_uk_v5 <- train(",model_v5,",
                      data = track_uk_train,
                      method = 'glmboost',
                      trControl = ctrl,
                      tuneGrid = mboost_grid,
...
# Voted - UK - socio_demo + topics

set.seed(48284)
eval(parse(text=paste("xgb_uk_v6a <- train(",model_v6,",
                      data = track_uk_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid0,
...
set.seed(29483)
eval(parse(text=paste("xgb_uk_v6 <- train(",model_v6,",
                      data = track_uk_train,
                      method = 'xgbTree',
                      trControl = ctrl,
                      tuneGrid = xgb_grid,
...
set.seed(29483)
eval(parse(text=paste("mb_uk_v6 <- train(",model_v6,",
                      data = track_uk_train,
                      method = 'glmboost',
                      trControl = ctrl,
                      tuneGrid = mboost_grid,
...
plot(varImp(xgb_de_v1), top = 20)
plot(varImp(xgb_de_v2), top = 20)
plot(varImp(xgb_de_v3), top = 20)
plot(varImp(xgb_de_v4), top = 20)
plot(varImp(xgb_de_v5), top = 20)
plot(varImp(xgb_de_v6), top = 20)

plot(varImp(xgb_fr_v1), top = 20)
plot(varImp(xgb_fr_v2), top = 20)
plot(varImp(xgb_fr_v3), top = 20)
plot(varImp(xgb_fr_v4), top = 20)
plot(varImp(xgb_fr_v5), top = 20)
plot(varImp(xgb_fr_v6), top = 20)

plot(varImp(xgb_uk_v1), top = 20)
plot(varImp(xgb_uk_v2), top = 20)
plot(varImp(xgb_uk_v3), top = 20)
plot(varImp(xgb_uk_v4), top = 20)
plot(varImp(xgb_uk_v5), top = 20)
plot(varImp(xgb_uk_v6), top = 20)
...
# Voted - Germany - socio_demo + reduced BERT
xgb_de_5 <- xgb_de_v5$finalModel
eval(parse(text=paste("x_data <- model.matrix(",model_v5," , track_de_train)[, -1]")))
shap_long <- shap.prep(xgb_de_5, X_train = x_data, top_n = 20)
shap.plot.summary(shap_long, dilute = T)

# Voted - France - socio_demo + reduced BERT
xgb_fr_5 <- xgb_fr_v5$finalModel
eval(parse(text=paste("x_data <- model.matrix(",model_v5," , track_fr_train)[, -1]")))
shap_long <- shap.prep(xgb_fr_5, X_train = x_data, top_n = 20)
shap.plot.summary(shap_long, dilute = T)

# Voted - UK - socio_demo + reduced BERT
xgb_uk_5 <- xgb_uk_v5$finalModel
eval(parse(text=paste("x_data <- model.matrix(",model_v5," , track_uk_train)[, -1]")))
...
p_xgb_de_v1 <- predict(xgb_de_v1, newdata = track_de_test, type = "prob")
p_xgb_de_v2 <- predict(xgb_de_v2, newdata = track_de_test, type = "prob")
p_xgb_de_v3 <- predict(xgb_de_v3, newdata = track_de_test, type = "prob")
p_xgb_de_v4 <- predict(xgb_de_v4, newdata = track_de_test, type = "prob")
p_xgb_de_v5 <- predict(xgb_de_v5, newdata = track_de_test, type = "prob")
p_xgb_de_v6 <- predict(xgb_de_v6, newdata = track_de_test, type = "prob")

p_xgb_fr_v1 <- predict(xgb_fr_v1, newdata = track_fr_test, type = "prob")
p_xgb_fr_v2 <- predict(xgb_fr_v2, newdata = track_fr_test, type = "prob")
p_xgb_fr_v3 <- predict(xgb_fr_v3, newdata = track_fr_test, type = "prob")
p_xgb_fr_v4 <- predict(xgb_fr_v4, newdata = track_fr_test, type = "prob")
p_xgb_fr_v5 <- predict(xgb_fr_v5, newdata = track_fr_test, type = "prob")
p_xgb_fr_v6 <- predict(xgb_fr_v6, newdata = track_fr_test, type = "prob")

p_xgb_uk_v1 <- predict(xgb_uk_v1, newdata = track_uk_test, type = "prob")
p_xgb_uk_v2 <- predict(xgb_uk_v2, newdata = track_uk_test, type = "prob")
p_xgb_uk_v3 <- predict(xgb_uk_v3, newdata = track_uk_test, type = "prob")
p_xgb_uk_v4 <- predict(xgb_uk_v4, newdata = track_uk_test, type = "prob")
p_xgb_uk_v5 <- predict(xgb_uk_v5, newdata = track_uk_test, type = "prob")
p_xgb_uk_v6 <- predict(xgb_uk_v6, newdata = track_uk_test, type = "prob")

roc_xgb_de_v1 <- roc(response = track_de_test$voted, predictor = p_xgb_de_v1$Yes)$auc
roc_xgb_de_v2 <- roc(response = track_de_test$voted, predictor = p_xgb_de_v2$Yes)$auc
roc_xgb_de_v3 <- roc(response = track_de_test$voted, predictor = p_xgb_de_v3$Yes)$auc
roc_xgb_de_v4 <- roc(response = track_de_test$voted, predictor = p_xgb_de_v4$Yes)$auc
roc_xgb_de_v5 <- roc(response = track_de_test$voted, predictor = p_xgb_de_v5$Yes)$auc
roc_xgb_de_v6 <- roc(response = track_de_test$voted, predictor = p_xgb_de_v6$Yes)$auc

voted_test_de <- data.frame("Country" = "Germany", 
                            "Model" = c("Model1", "Model2", "Model3", "Model4", "Model5", "Model6"),
                            "AUC" = rbind(roc_xgb_de_v1, roc_xgb_de_v2, roc_xgb_de_v3, roc_xgb_de_v4, roc_xgb_de_v5, roc_xgb_de_v6))

roc_xgb_fr_v1 <- roc(response = track_fr_test$voted, predictor = p_xgb_fr_v1$Yes)$auc
roc_xgb_fr_v2 <- roc(response = track_fr_test$voted, predictor = p_xgb_fr_v2$Yes)$auc
roc_xgb_fr_v3 <- roc(response = track_fr_test$voted, predictor = p_xgb_fr_v3$Yes)$auc
roc_xgb_fr_v4 <- roc(response = track_fr_test$voted, predictor = p_xgb_fr_v4$Yes)$auc
roc_xgb_fr_v5 <- roc(response = track_fr_test$voted, predictor = p_xgb_fr_v5$Yes)$auc
roc_xgb_fr_v6 <- roc(response = track_fr_test$voted, predictor = p_xgb_fr_v6$Yes)$auc

voted_test_fr <- data.frame("Country" = "France", 
                            "Model" = c("Model1", "Model2", "Model3", "Model4", "Model5", "Model6"),
                            "AUC" = rbind(roc_xgb_fr_v1, roc_xgb_fr_v2, roc_xgb_fr_v3, roc_xgb_fr_v4, roc_xgb_fr_v5, roc_xgb_fr_v6))

roc_xgb_uk_v1 <- roc(response = track_uk_test$voted, predictor = p_xgb_uk_v1$Yes)$auc
roc_xgb_uk_v2 <- roc(response = track_uk_test$voted, predictor = p_xgb_uk_v2$Yes)$auc
roc_xgb_uk_v3 <- roc(response = track_uk_test$voted, predictor = p_xgb_uk_v3$Yes)$auc
roc_xgb_uk_v4 <- roc(response = track_uk_test$voted, predictor = p_xgb_uk_v4$Yes)$auc
roc_xgb_uk_v5 <- roc(response = track_uk_test$voted, predictor = p_xgb_uk_v5$Yes)$auc
roc_xgb_uk_v6 <- roc(response = track_uk_test$voted, predictor = p_xgb_uk_v6$Yes)$auc

voted_test_uk <- data.frame("Country" = "UK", 
                            "Model" = c("Model1", "Model2", "Model3", "Model4", "Model5", "Model6"),
                            "AUC" = rbind(roc_xgb_uk_v1, roc_xgb_uk_v2, roc_xgb_uk_v3, roc_xgb_uk_v4, roc_xgb_uk_v5, roc_xgb_uk_v6))
...
ggsave("v_roc.png", width = 8, height = 6)

save.image("v_results_all.RDATA")
