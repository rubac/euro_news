...
def get_vect2(lst_to_encode) : 
    ...
    ''' Verifier que le serveur Bert est bien lanc !! '''
    ...
    for i in range (0, len(lst_to_encode)) :
        ...
        if (i+1)%100==0 : 
            ...
            print("temps ecoule --------> : ", temps, "secondes, -",i,"-  reste ----------> ",reste ," lignes, temps restant ------------> ", tmp_rest," minutes")
            bc = BertClient(port=port, port_out=port_out, show_server_config=False)
...
default_model_location    = 'C:/Users/bachr/Desktop/Denis title encodings/pretrained/uncased_L-12_H-768_A-12/'

# fine_tuned_model_location = '/home/ubuntu/TENSOR/finetuned/'
fine_tuned_model_location = 'C:/Users/bachr/Desktop/Denis title encodings/finetuned/'
...
# df = pd.read_csv('/home/ubuntu/TENSOR/UKDAT/UK_searches2.csv',sep=",")
df = pd.read_csv('C:/Users/bachr/Desktop/Denis title encodings/UK_searches.csv',sep=";")

# drop_na = [x for x in df['search'].index if df['search'].iloc[x] == '']
# df2 = df.drop(drop_na)
# df2 =  df2.reset_index(drop = True)
# df['search'] = str(df['search'])
# type(df['search'])
...
dff.to_csv("/home/ubuntu/TENSOR/UKDAT/search_mean_strategy.csv",sep=";",encoding="UTF-8",index = False)
